...
//            removeBleConnectedDevice()
        ...
        if (!systemConnectStatus || !bleCoreConnectStatus || isForceConnect || bluetoothGatt == null) {
            bleConnectCallback.callConnectStart(bleDevice.deviceAddress?:"")
            getBleConnectedDevice(bleDevice)?.getBleEventCallback()?.callConnectStart(bleDevice.deviceAddress?:"")
            startConnectJob()
        } else {
